  ...
  <div class="min-h-screen bg-gray-100">
    ...
    <header class="bg-white shadow-sm">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center gap-4">
        ...
        <h1 class="text-xl font-bold text-navy-900">Add New Product</h1>
      </div>
    </header>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 space-y-5">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div>
              ...
              <input v-model="form.slug" type="text" class="input-field" placeholder="rigid-gift-box (auto-generated if empty)" />
            </div>
          </div>
...
useSeo({ title: 'Add Product | Admin', description: 'Admin add product page.', noindex: true })
...
const handleSubmit = async () => {
  ...
  try {
    ...
    errorMessage.value = 'Failed to save product. Please check your inputs and try again.'
  } finally {
    saving.value = false
  }
}
